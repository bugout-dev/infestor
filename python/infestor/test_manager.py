...
class TestGetReporterImportInformationFromComplexConfiguration(unittest.TestCase):
    ...
    def test_reporter_import_information_from_nonrelative_configuration(self):
        reporter_import_path, is_relative, reporter_object_name = manager.get_reporter_import_information(self.repository, self.submodule_path, self.nonrelative_configuration)
    ...
    def test_reporter_import_information_from_relative_configuration(self):
        reporter_import_path, is_relative, reporter_object_name = manager.get_reporter_import_information(self.repository, self.submodule_path, self.relative_configuration)
