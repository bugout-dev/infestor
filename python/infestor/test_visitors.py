...
class TestReporterFileVisitor(InfestorTestCase):
    ...
    def test_visitor(self):
        ...
        syntax_tree = visitor.syntax_tree(os.path.join(self.package_dir, self.config.reporter_filepath))
        ...
        self.assertGreater(visitor.HumbugConsentInstantiatedAt, visitor.HumbugConsentImportedAt)
        ...
        self.assertGreater(visitor.HumbugReporterImportedAt, visitor.HumbugConsentImportedAt)
        self.assertGreater(visitor.HumbugReporterInstantiatedAt, visitor.HumbugReporterImportedAt)
